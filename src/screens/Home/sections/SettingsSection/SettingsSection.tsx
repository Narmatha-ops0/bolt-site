  ...
  return (
    <section className="relative w-full h-[840px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(0deg,rgba(0,0,0,0.24)_0%,rgba(0,0,0,0.24)_100%),linear-gradient(38deg,rgba(0,0,0,0.8)_4%,rgba(0,0,0,0.8)_52%,rgba(75,174,255,0.6)_100%)]" />
      </div>
        ...
        <TabsList className="flex w-full h-10 items-center justify-center gap-0 bg-[#ffffff3d] overflow-hidden p-0 rounded-none">
          {tabsData.map((tab) => (
            <TabsTrigger
              key={tab.value}
              value={tab.value}
              className="flex h-10 px-10 py-3 flex-1 grow data-[state=active]:[background:radial-gradient(50%_50%_at_41%_50%,rgba(108,224,255,1)_0%,rgba(164,160,255,1)_100%)] items-center justify-center gap-2 data-[state=active]:text-[#090909] text-white hover:bg-[#ffffff20] rounded-none border-0"
            >
              <span className="[font-family:'Geist_Mono',Helvetica] font-bold text-sm text-center tracking-[0] leading-6">
                {tab.label}
              </span>
            </TabsTrigger>
          ))}
      ...
      <div className="absolute top-[94px] left-1/2 transform -translate-x-1/2 w-[1258px] h-[580px] overflow-hidden border border-solid border-transparent backdrop-blur-[56px] [border-image:linear-gradient(179deg,rgba(214,211,241,0.5)_0%,rgba(40,63,129,0.5)_100%)_1] bg-[linear-gradient(180deg,rgba(41,50,90,0.8)_0%,rgba(3,2,13,0.8)_100%)]">
        
        {/* Background Glow Effect */}
        <div className="absolute top-[-297px] left-[147px] w-[367px] h-[619px] rounded-[183.37px/309.37px] rotate-[105deg] shadow-[inset_0px_-68px_4px_#dabbf580,inset_0px_-28px_4px_#6b45dd,inset_0px_-16px_4px_#27069d,0px_4px_4px_#00000040] blur-[150px] bg-[linear-gradient(30deg,rgba(92,88,206,0.2)_4%,rgba(67,215,255,0.2)_100%)]" />
        ...
        {/* Left Side Content */}
        <div className="absolute top-1/2 left-[92px] transform -translate-y-1/2 w-[333px] flex flex-col items-start justify-center gap-10">
          <div className="flex flex-col items-start gap-2 w-full">
            <div className="opacity-50 [font-family:'Geist_Mono',Helvetica] text-sm font-medium text-white tracking-[0] leading-6">
              {tabsData.find((tab) => tab.value === activeTab)?.step}
            </div>

            <h2 className="[font-family:'Geist',Helvetica] font-semibold text-white text-2xl tracking-[0] leading-8">
        ...
        <div className="absolute -top-1 left-[410px] w-[852px] h-[588px]">
          ...
          <div className="absolute top-[418px] left-[496px] w-[62px] h-12">
            ...
            <div className="absolute top-[23px] left-1/2 transform -translate-x-1/2 gap-1 px-2 py-1 bg-white border border-solid border-black shadow-[0px_10.42px_31.27px_2.61px_#00000033] inline-flex items-center justify-center rounded">
      ...
      {/* Bottom Section */}
      <div className="absolute top-[705px] left-1/2 transform -translate-x-1/2 flex flex-col items-center justify-center gap-4">
        <div className="opacity-50 [font-family:'Geist_Mono',Helvetica] font-medium text-white text-xs tracking-[0] leading-6">
